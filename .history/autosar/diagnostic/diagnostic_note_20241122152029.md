 ...
 * @LastEditTime: 2024-11-22 15:20:29
 * @Description: 
-->
...
一类用于具体的PID 数据
而另一类则用来读取ECU支持哪些P1D
用于第二种目的的PID分别是000，0x20，0x40…，读取其中一个JD后ECU会返回1个字节的结果，这4个字节中的每个bit表示其所对应的PID是否被支持。以下面这个例子来说明就很容易理解了:
服务1为01P为0000是用来读取该ECU支持哪些PD的
