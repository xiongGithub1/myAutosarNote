 ...
 * @LastEditTime: 2024-11-26 13:55:43
 * @Description: 
-->
...
当FEE作为AUTOSAR存储模块的核心软件层，这一层需要考虑到**FLASH使用寿命、BLOCK 稳定写入、换页时长、启动换页值、BANK大小**等关键功能设计。AUTOSAR作为车载软件的标准，在很多模块设计上都会考虑到实际应用场景，满足车载软件的高标准要求。