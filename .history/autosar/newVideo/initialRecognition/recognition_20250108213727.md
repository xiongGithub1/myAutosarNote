 ...
 * @LastEditTime: 2025-01-08 21:37:27
 * @Description: 
-->
...
3.1.1、基本点
(1)AutosarCP的0S是RTOS的一种，但是和典工业消费级的如freertos等有差异，也多了多学习点(2)AutosarCP的0S基于0SEKOS，又做了一些护展。所以先学0SEKOS，再针对性学扩展点实现是解决方案商的事儿，要么购买要么自(3)0SEK和Autosar只规定了0S的特性和行为，
3.1.2、0S核心价值(1)Autosar系统中“干活"的是Application和3SW，而0S是支撑体系，不干“功能性的活儿”(2)0S主要与Application和BSW打交道，将后，这是0S对CPU的管理2者的运行entities分配到0S的task中运行实型(3)0S还对硬件中断有管理，实现ISR机制，这也是为了服务Application和BSW。计时彼此都是独立的，都是标准API，通过西置生成、RTE来对接。(4)Autosar体系下，application、bsw、os飞
3.1.3、本课程的目标和价值(1)从设计哲学和方法论上理解AutosarCP的0与Application和BSW，如何协作工作。进而更深入理解Autosar(2)结合文档和讲解，深度理解0S的核心概念如调度机制、任务管理、优先级、alarm、rsources等。(3)结合文档和代码，对AutosarCP体系的实型有直观认识，应聘和工作中获得竞争优势。
3.1.4、本课程如何讲如何学
(1)资料1:点.pptx》《AUTOSAR Classic操作系统-重邓(2)资料2:《IS017356-3翻译版.docx》(3)资料3:Autosar官方文档中0S部分