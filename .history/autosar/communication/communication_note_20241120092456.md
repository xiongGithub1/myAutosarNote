 ...
 * @LastEditTime: 2024-11-20 09:24:56
 * @Description: 
-->
...
对于CAN诊断而言，由于存在多帧传输，需要将N-SDU进行分段传输，分段成多帧N-PDU，N-PDU会加上N-PCI协议控制信息。
![20241119162738](https://cdn.jsdelivr.net/gh/xiongGithub1/picGoUpload/image/20241119162738.png)
...
#### 信号发送接收数据流
1. COM和PduR接口
![20241120092335](https://cdn.jsdelivr.net/gh/xiongGithub1/picGoUpload/image/20241120092335.png)![1732065879167](image/communication_note/1732065879167.png)
2. 22