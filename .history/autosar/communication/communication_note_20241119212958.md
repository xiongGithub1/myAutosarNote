 ...
 * @LastEditTime: 2024-11-19 21:29:17
 * @Description: 
-->
...
这是一个DBC文件(**也就是CAN总线数据库文件，定义了详细的CAN报文和信号**)里面定义了message和signal，message就是一条can报文，signal就是报文里面的信号，而com 层向上层 RTE 提供的就是基于信号的接口。
