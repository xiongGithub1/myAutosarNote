 ...
 * @LastEditTime: 2024-12-17 19:14:04
 * @Description: 
-->
...
应用层模块通过RET调用C0M模块ComSendSignal请求发送信号1.!2.COM写信号进PDUbuffer
3.PDU被事先定义好的PDU路由表，发送到指定目的层(根据PDUID来查找PDU的路由表)，比如CAN总线的PDU就会路由到CanIf层，Lin的PDU就会路由到LinIf 层。
### 4.总结
