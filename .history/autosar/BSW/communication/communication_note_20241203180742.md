 ...
 * @LastEditTime: 2024-12-03 18:07:42
 * @Description: 
-->
...
从图中可以看出，CAN总线通信需要CPU CAN控制器 can收发器参与。引出两根线CANHCANL，所有节点都挂接到这两根线上，就形成了CAN的网络结构。图中有两路CAN总线，带有终端电阻1202的是高速CAN，没有带终端1202的低速容CAN。
